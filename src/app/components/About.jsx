    ...
    <div className="hero bg-base-200 min-h-screen min-w-screen px-8" id='about'>
        ...
        <Image priority={true} src="/aboutPic.png" width={400} height={400} alt='My pic' className="rounded-2xl pt-8 mx-5 md:mb-8" id='about_pic'></Image> {/* border-solid border-8 border-sky-200 px-8 */}
          <div>
            ...
            <p className="py-6 xl:text-xl sm:text-xl">Hi, my name is Boss. I'm a 17-year-old senior high school student from Thailand who wants to be a Full-Stack Developer in the future. My hobbies are listening to music, watching movies, and coding. I will apply to university next year and hope to study Computer Science.</p>
